...
from .chunkr_parser import parse_chunk          # dùng LlamaIndex nodes với metadata chi tiết
...
DATA_ROOT      = "docs"   # sẽ quét: data/<product_line>/<product_name>/*
